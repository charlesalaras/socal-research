...
class HighwayLSTMFunction(NestedIOFunction):
    ...
    def forward_extended(self, input, weight, bias, hy, cy, dropout, lengths, gates):
        ...
        print("\nMINI BATCH: " + str(self.mini_batch))      
        print("\nXTENSOR SIZE: " + str(input.size()))
        print("\nLENGTHS SIZE: " + str(lengths.size()))
        print("\nH DATA SIZE: " + str(hy.size()))
        print("\nC DATA SIZE: " + str(cy.size()))
        print("\nTMP_I SIZE: " + str(tmp_i.size()))
        print("\nTMP_H SIZE: " + str(tmp_h.size()))
        print("\nWEIGHT SIZE: " + str(weight.size()))
        print("\nBIAS SIZE: " + str(bias.size()))
